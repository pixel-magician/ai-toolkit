    ...
    <>
      ...
      <MainContent>
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label htmlFor="TRAINING_FOLDER" className="block text-sm font-medium mb-2">
                    训练文件夹路径
                    <div className="text-gray-500 text-sm ml-1">
                      我们将在这里存储您的训练信息。必须是绝对路径。如果为空，它将默认使用项目根目录中的输出文件夹。
                    </div>
                  </label>
                  <input
                    type="text"
                  ...
                  <label htmlFor="DATASETS_FOLDER" className="block text-sm font-medium mb-2">
                    ...
                    <div className="text-gray-500 text-sm ml-1">
                      ...
                      <span className="text-orange-800">
                        警告：此软件可能会修改数据集，因此建议您将备份存储在其他地方或为此软件使用专用文件夹。
                      </span>
                    </div>
                  </label>
                  <input
          ...
          >
            {status === 'saving' ? '正在保存...' : '保存'}
          </button>

          {status === 'success' && <p className="text-green-500 text-center">设置已成功保存！</p>}
